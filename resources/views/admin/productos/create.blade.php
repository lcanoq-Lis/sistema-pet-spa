            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                ...
                <div style="grid-column:span 2;">
                    ...
                    <textarea name="descripcion" rows="3"
                        style="width:100%; border:2px solid #d7ccc8; border-radius:10px; padding:10px 14px; font-size:14px; outline:none; font-family:Poppins,sans-serif; resize:vertical;">{{ old('descripcion') }}</textarea>
                </div>
